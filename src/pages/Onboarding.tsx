...
const ageRanges = [
    { max: 20, maintain: 2200, burn: 400 },
    { max: 30, maintain: 2400, burn: 450 },
    { max: 40, maintain: 2300, burn: 420 },
    { max: 50, maintain: 2200, burn: 400 },
    { max: 60, maintain: 2000, burn: 350 },
    { max: 120, maintain: 1800, burn: 300 },
]
        ...
        <div className="onboarding-container">
            ...
            <div className="p-6 pt-12 onboarding-wrapper">
             <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Welcome to Fitness Tracker!</h1>
                </div>
                ...
                <div className = "flex-1 px-6 onboarding-wrapper">
                    {step===1 && (
                        <div className = "space-y-6">
                            ...
                            <Input label="Age" type="number"className="max-w-2xl" value={formData.age} onChange={(v) => updateField('age', v )} placeholder="Enter your age" min={11} max={100} required/>
                        </div>
                    )}
                    ...
                    {step===2 && (
                        <div className = "space-y-6">
                            <div className= "flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    <h2 className="text-lg-font-semibold text-slate-800 dark: text-white">What's your weight and height?</h2>
                                    <p className="text-slate-500 dark : text -slate -400 text-sm">This helps us calculate your needs</p>
                                </div>
                            </div>
                            <Input label="Weight (kg)" type="number" className="max-w-2xl" value={formData.weight} onChange={(v) => updateField('weight', v)} placeholder="Enter your weight" required/>
                            <Input label="Height (cm)" type="number" className="max-w-2xl" value={formData.height} onChange={(v) => updateField('height', v)} placeholder="Enter your height"/>
                        </div>
                    )}
                    ...
                    {step===3 && (
                        <div className = "space-y-6 onboarding-wrapper">
                            <div className= "flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    <h2 className="text-lg-font-semibold text-slate-800 dark: text-white">What are your measurements</h2>
                        ...
                        <div className="space-y-8 max-w-lg">
                            ...
                            <div className="space-y-6">
                                <Slider label="Daily Calories Intake" min={120} max={8000} step={50} value={formData.dailyCaloriesIntake} onChange={(v) => updateField('dailyCaloriesIntake', v)}unit="kcal" infoText="This is the total calories you plan to consume each day." />

                                <Slider label="Daily Calories Burn" min={100} max={8000} step={50} value={formData.dailyCaloriesBurn} onChange={(v) => updateField('dailyCaloriesBurn', v)}unit="kcal" infoText="This is the total calories you plan to burn each day through exercise and activity." />
