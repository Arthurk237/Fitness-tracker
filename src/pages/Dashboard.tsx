...
import CaloriesChart from "../component/ui/CaloriesChart"
...
const Dashboard = () => {
  ...
  const DAILY_CALORIE_LIMIT: number = user?.dailyCaloriesIntake || 2000
  ...
  const loadUserData = () => {
    ...
    setTodayFood(foodData)           // ⭐ FIXED
    setTodayActivities(activityData) // ⭐ FIXED
  }
    ...
    <div className="page-container">
      ...
      <div className="dashboard-header">
        ...
        <h1 className="text-2xl font-bold mt-1">
          {`Hi there! 😊 ${user?.username || "Athlete"}`}
        </h1>
        ...
        <Card className="shadow-lg col-span-2">
          ...
          {/* Calories Burned */}
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-slate-800 dark:text-white">{user?.dailyCaloriesBurn || 400}</p>

            </div>

            </div>
            <ProgressBar value={totalBurned} max={user?.dailyCaloriesBurn || 400} />
